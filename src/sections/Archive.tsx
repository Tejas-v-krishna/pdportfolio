  ...
  return (
    <section id="play" className="px-6 sm:px-12 md:px-16 lg:px-20 w-full mb-20">
      ...
      <div className="flex flex-col gap-6">
        ...
        {/* Large Bento Item */}
        <div className="bg-white rounded-[2rem] p-6 sm:p-10 shadow-[0_4px_40px_-10px_rgba(0,0,0,0.05)] border border-gray-100">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="bg-white rounded-[2rem] p-6 sm:p-10 shadow-[0_4px_40px_-10px_rgba(0,0,0,0.05)] border border-gray-100 flex flex-col justify-between">
            <div>
