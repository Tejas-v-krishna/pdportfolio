...
export const SmoothCursor = ({
  ...
  springConfig = {
    ...
    mass: 0.2,      // Very light, zero lag feeling
    restDelta: 0.001,
  },
}: SmoothCursorProps) => {
  ...
  useEffect(() => {
    ...
    const updateVelocity = (currentPos: Position) => {
      ...
      const deltaTime = lastUpdateTime.current === 0 ? 0 : currentTime - lastUpdateTime.current
  ...
  return (
    <motion.div
      ...
      style={{
        ...
        translateX: "-50%",
        translateY: "-50%",
        rotate: -20, // Tilted to the left to look like a standard system cursor
        scale: scale,
        zIndex: 10000,
        pointerEvents: "none",
